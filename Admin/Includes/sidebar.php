<ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
    ...
    <li class="nav-item"> 
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Manage Students</h6>
          <a class="collapse-item" href="createStudents.php">Manage Enrollement</a>
          <!-- <a class="collapse-item" href="#">Assets Type</a> -->
         </div>
        </div>
    </li>
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapParent" aria-expanded="true" aria-controls="collapseBootstrapParent">
         <i class="fas fa-user"></i>
         <span>Manage Parents</span>
        </a>
        <div id="collapseBootstrapParent" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Manage Parents</h6>
          <a class="collapse-item" href="createParent.php">Create Parent</a>
         </div>
        </div>
    </li>
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="createSessionTerm.php">Create School Year</a>
     ...
     <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapAtt" aria-expanded="true" aria-controls="collapseBootstrapAtt">
             <i class="fas fa-clipboard-list"></i>
             <span>Attendance Record</span>
         </a>
         <div id="collapseBootstrapAtt" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Attendance</h6>
                 <a class="collapse-item" href="manageAttendance.php">Manage Records</a>
             </div>
         </div>
     </li>
     <!-- <li class="nav-item">
