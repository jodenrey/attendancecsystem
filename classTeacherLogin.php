...
<body class="bg-gradient-login">
  ...
  if(isset($_POST['login'])){
    ...
    $query = "SELECT t.*, ca.classId, ca.Id as classArmId 
              FROM tblclassteacher t 
              LEFT JOIN tblclassarms ca ON ca.teacherId = t.Id 
              WHERE t.emailAddress = '$username' AND t.password = '$password'";
    ...
    if($num > 0){
      ...
      $_SESSION['userType'] = 'Teacher'; // Setting the user type for consistency
