...
include '../Includes/check_default_password.php';
    ...
    // Handle case when teacher has no assigned class yet
    if(!$rrw) {
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (<?php echo $className . ($classArmName ? ' - ' . $classArmName : ''); ?>)</h1>
            <ol class="breadcrumb">
